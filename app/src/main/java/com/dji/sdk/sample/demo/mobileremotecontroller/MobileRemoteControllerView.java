...
public class MobileRemoteControllerView extends RelativeLayout
    ...
    private static final long LANDING_DELAY_MS = 30000;
    ...
    private void initUI() {
        ...
        autoFly = (Button) findViewById(R.id.btn_autofly);
        autoFly.setOnClickListener(this);
